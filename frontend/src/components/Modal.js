...
export default function Modal (props) {
    ...
    const {title, genre, author, price, src, age, isbn, date, handleAddProducts} = props;
    ...
    return (
        <>
            <button className="btn-modal" onClick={toggleModal}> Learn More </button>
            {modal && ( 
                ...
                <div className="modal">
                    <div className="overlay">
                        <div className="modal-content">
                            <img src={props.src} alt="" className="modal-image" />
                            <div className="modal-text">
                                ...
                                <h5>ISBN: {isbn} </h5>
                                <button onClick={() => handleAddProducts(props)}> Add To Cart </button>
                            </div>
